...
const leaders = [
  ...
  },
  {
    ...
    bio: (
      <>
        <p className="mb-4">
          With a <strong className="text-white font-bold">Post-Graduate qualification in Personnel Management</strong> and membership in the <strong className="text-white font-bold">CIEH (UK)</strong> and <strong className="text-white font-bold">ASIS (USA)</strong>, Mr. Thomas brings strong technical expertise.
        </p>
        <p>
          He has over <strong className="text-white font-bold">15 years of professional experience</strong>. His guidance ensures that Al Fateen maintains international standards in cleaning and pest control services across all sectors.
        </p>
      </>
    ),
    badges: [
...
export default function LeadershipSection() {
  return (
    // REDUCED: py-24 md:py-40 -> py-12 md:py-24
    <section data-header-theme="dark" className="relative py-12 md:py-24 bg-[#050505] text-white overflow-hidden">
      ...
      <div className="absolute top-4 left-1/2 -translate-x-1/2 text-[10vw] font-bold text-white/[0.02] pointer-events-none select-none leading-none z-0 whitespace-nowrap">
        LEADERSHIP
      </div>

      {/* REDUCED: space-y-48 -> space-y-24 */}
  ...
  return (
    ...
    <div className={`flex flex-col ${isReversed ? 'lg:flex-row-reverse' : 'lg:flex-row'} gap-8 lg:gap-12 items-center`}>
      ...
      >
        ...
        {/* Floating Glass Card - Compact Version */}
      ...
      >
        ...
        {/* Name - REDUCED: text-7xl -> text-4xl/5xl */}
        ...
        {/* Quote - REDUCED: text-3xl -> text-xl */}
        {data.quote && (
